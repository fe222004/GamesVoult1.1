...
@Component({
  selector: 'app-presentacion-game',
  templateUrl: './presentacion-game.component.html',
  styleUrl: './presentacion-game.component.css',
})
export class PresentacionGameComponent {
